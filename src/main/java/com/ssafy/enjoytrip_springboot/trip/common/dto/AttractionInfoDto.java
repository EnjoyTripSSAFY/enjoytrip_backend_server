...
public class AttractionInfoDto {
	...
	public static AttractionResponse parseToResponse (AttractionInfoDto info){
		return AttractionResponse.builder()
				.addr1(info.getAddr1())
				.addr2(info.getAddr2())
				.areacode(info.getSidoCode())
				...
				.mapx(info.getLongitude())
				.mapy(info.getLatitude())
				.mlevel(info.getMlevel())
				.sigungucode(info.getGugunCode())
				.tel(info.getTel())
				.title(info.getTitle())
